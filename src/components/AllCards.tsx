...
const AllCards: FunctionComponent<AllCardsProps> = ({ cardsChange, setCardsChange, refresh }) => {
        ...
        <div className="container">
            <div className="row ">
                {cards.length ? (cards.map((card) => (
                    ...
                    <CardComponent card={card} setCardId={setCardId} setOpenDeleteModal={setOpenDeleteModal} setOpenUpdateModal={setOpenUpdateModal} cardsChange={cardsChange} setCardsChange={setCardsChange} refresh={refresh} setCardRemove={setCardRemove} cardRemove={cardRemove} />
