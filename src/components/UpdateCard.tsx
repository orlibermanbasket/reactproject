...
const UpdateCard: FunctionComponent<UpdateCardProps> = ({ onHide, cardId, refresh }) => {
    ...
    let [card, setCard] = useState<BuisnessCard>({ buisnessName: "", buisnessDescription: "", buisnessAdress: "", buisnessPhone: "", buisnessImage: "" })
    useEffect(() => {
        getCardById(cardId).then((res) => setCard(res.data)).catch((err) => console.log(err)
        )
    }, []);
    let formik = useFormik({
        initialValues: { buisnessName: card.buisnessName, buisnessDescription: card.buisnessDescription, buisnessAdress: card.buisnessAdress, buisnessPhone: card.buisnessPhone, buisnessImage: card.buisnessImage },
        ...
        validationSchema: yup.object({
            ...
            buisnessPhone: yup.string().required().min(8),
